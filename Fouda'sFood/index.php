...
<div class="user-profile">
   ...
   <div class="flex">
      <a href="index.php?logout=<?php echo $user_id; ?>" onclick="return confirm('هل أنت متأكد أنك تريد تسجيل الخروج؟');" class="delete-btn">Logout</a>
   </div>
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><?php echo $fetch_cart['price']; ?>EGP </td>
            <td>
            ...
            <td><?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>EGP</td>
      ...
      <tr class="table-bottom">
         ...
         <td><?php echo $grand_total; ?>EGP</td>
         <td><a href="index.php?delete_all" onclick="return confirm('حذف كل المنتجات من العربة?');" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>"> Delete All</a></td>
      </tr>
   </tbody>
   </table>
